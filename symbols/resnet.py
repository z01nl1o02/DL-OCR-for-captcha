...
def resnet18(last_pool=True,num_classes=10,pretrained=False,verbose=False,**kwargs):
    model = ResNet(BasicBlock,[2,2,2,2],last_pool=last_pool,
                   num_classes=num_classes,verbose=verbose,**kwargs)
    return model

def resnet34(last_pool=True,num_classes=10,pretrained=False,verbose=False,**kwargs):
    model = ResNet(BasicBlock,[3,4,6,3],last_pool=last_pool,
                   num_classes=num_classes,verbose=verbose,**kwargs)
    return model

def resnet50(last_pool=True,num_classes=10,pretrained=False,verbose=False,**kwargs):
    model = ResNet(Bottleneck,[3,4,6,3],last_pool=last_pool,
                   num_classes=num_classes,verbose=verbose,**kwargs)
    return model

def resnet101(last_pool=True,num_classes=10,pretrained=False,verbose=False,**kwargs):
    model = ResNet(Bottleneck,[3,4,23,3],last_pool=last_pool,
            num_classes=num_classes,verbose=verbose,**kwargs)
    return model

def resnet152(last_pool=True,num_classes=10,pretrained=False,verbose=False,**kwargs):
    model = ResNet(Bottleneck,[3,8,36,3],last_pool=last_pool,
                   num_classes=num_classes,verbose=verbose,**kwargs)
    return model
